...
public class LoggerAdvice {
	...
	@Before("within(com.example..*) && @annotation(loggerManage)")
	...
	@AfterReturning("within(com.example..*) && @annotation(loggerManage)")
	public void addAfterReturningLogger(JoinPoint joinPoint, LoggerManage loggerManage) {
		logger.info("执行 " + loggerManage.description() + " 结束");
	}
	
	@AfterThrowing(pointcut = "within(com.example..*) && @annotation(loggerManage)", throwing = "ex")
